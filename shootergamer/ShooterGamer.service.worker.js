...
/** @type {string} */
const CACHE_VERSION = '1746703997|17213726265';
/** @type {string} */
const CACHE_PREFIX = 'Corruption Clean-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ShooterGamer.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ShooterGamer.html","ShooterGamer.js","ShooterGamer.offline.html","ShooterGamer.icon.png","ShooterGamer.apple-touch-icon.png","ShooterGamer.worker.js","ShooterGamer.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["ShooterGamer.wasm","ShooterGamer.pck"];
